...
import { verifyLocalTaxPayment } from '../../../services/paymentService';
import Swal from 'sweetalert2';

const LocalTaxSuccess = () => {
    ...
    useEffect(() => {
        ...
        const verifyPayment = async () => {
            ...
            try {
                // Use the verifyLocalTaxPayment service function
                const data = await verifyLocalTaxPayment(sessionId);
    ...
    const handleContinue = () => {
        if (status === 'success') {
            ...
            const serviceTypeTitle = sessionStorage.getItem('serviceTypeTitle') || 'Local Tax';
            ...
            <Card className="max-w-md w-full text-center p-8 glass2">
                ...
                {status === 'success' && (
                    <div className="flex flex-col items-center justify-center py-4">
                        ...
                        <p className="text-gray-500 mb-6">Your payment has been recorded with the city council system.</p>
...
export default LocalTaxSuccess;
